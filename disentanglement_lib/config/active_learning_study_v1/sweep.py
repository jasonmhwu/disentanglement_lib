...
def get_default_models():
  ...
  betas = h.sweep("s2_vae.beta", h.discrete([1., 2., 4., 6., 8., 16.]))
  gamma_sups = h.sweep("s2_vae.gamma_sup", h.discrete([1., 2., 4., 6., 8., 16.]))
...
class ActiveLearningStudyV1(study.Study):
  """Defines the study for the paper."""
  def __init__(self):
    self.study_name = "active_learning_study_v1"
