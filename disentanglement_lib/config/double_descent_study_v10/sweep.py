...
def get_default_models():
    ...
    all_models = h.chainit([
        config_beta_vae, config_annealed_beta_vae
    ])
    return all_models
...
class DoubleDescentStudyV10(study.Study):
    ...
    def get_model_config(self, model_num=0):
        ...
        model_config_file = resources.get_file(
            "config/double_descent_study_v10/model_configs/shared.gin")
    ...
    def get_postprocess_config_files(self):
        ...
        return list(
            resources.get_files_in_folder(
                "config/double_descent_study_v10/postprocess_configs/"))

    def get_eval_config_files(self):
        """Returns evaluation config files."""
        return list(
            resources.get_files_in_folder(
                "config/double_descent_study_v10/metric_configs/"))
