...
def get_datasets():
    ...
    datasets = ["dsprites_full", "smallnorb", "mpi3d_toy", "shapes3d"]
...
def get_default_models():
    ...
    num_stochastic_passes = h.sweep("s2_vae.num_stochastic_passes", h.discrete([8]))
...
class ActiveLearningStudyV13(study.Study):
    """Defines the study for the paper."""

    def __init__(self):
        self.study_name = "active_learning_study_v13"
