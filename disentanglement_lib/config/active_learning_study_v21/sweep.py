...
def get_datasets():
    ...
    for dataset in datasets:
        ...
        full_list = list(range(num_factors))
        observed_factors_list = [full_list[:i] + full_list[i+1:] for i in range(num_factors)]
        observed_factors_list.append(full_list)
...
class ActiveLearningStudyV21(study.Study):
    """Defines the study for the paper."""

    def __init__(self):
        self.study_name = "active_learning_study_v21"
