...
def get_datasets():
    ...
    datasets = ["dsprites_full", "mpi3d_toy"]
...
def get_supervised_loss():
    ...
    supervised_loss = h.sweep(
        ...
        h.discrete(['xent_and_cov', 'l2_and_cov']),
    )
    cov_loss_ratio = h.sweep(
        "supervised_loss.cov_loss_ratio",
        h.discrete([0, 0.125, 0.5, 1, 4]),
    )
...
class ActiveLearningStudyV15(study.Study):
    """Defines the study for the paper."""

    def __init__(self):
        self.study_name = "active_learning_study_v15"
